...
public class CorrectionTest {
	...
	public static void testCorrection() {
		...
		// String[] input = tokenizer.tokenize("matanggap matanggap mag lalaro
		// matanggap palang matanggap.*#");
		// String[] input = tokenizer.tokenize("matanggap matanggap matanggap
		// palang matanggap mag lalaro.*#");
		// String[] input = tokenizer.tokenize("matanggap matanggap matanggap
		// palang matanggap mag.*#");
